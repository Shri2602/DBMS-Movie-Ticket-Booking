  ...
  <body>
    ...
    <div class="container-fluid px-1 py-5 mx-auto">
      <div class="row d-flex justify-content-center">
          ...
          <button type="button" class="btn btn-success" onclick="window.location='admin_movielist.php';">Go Back</button>
              <div class="card">
                  <h3 class="text-center mb-4">UPDATE MOVIE</h3>
                  <form class="form-card" method="POST" action="admin_movie_update.php">
                      ...
                      <div class="row justify-content-center">
                          <div class="form-group col-sm-6 mt-3"> <button type="submit" name= "submit" class="btn-block btn-primary">UPDATE</button> </div>
                      </div>
                  </form>
              </div>
          </div>
